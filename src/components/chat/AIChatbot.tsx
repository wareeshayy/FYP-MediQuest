...
export function AIChatbot({ topicId, quizId, sourceContent, topicName }: AIChatbotProps) {
  ...
  const getInitialMessage = () => {
    if (!topicId && !quizId) {
      // On create quiz page
      return `Hello! I'm your AI quiz creation assistant. I can help you:
• Brainstorm topic ideas and content
• Improve your quiz content
• Suggest better questions
• Explain concepts
• Generate quiz ideas from your topic

${topicName ? `You're working on: **${topicName}**\n` : ''}${sourceContent ? `I can see you've added some content. Ask me to help improve it or generate questions!` : 'What would you like help with?'}`;
    } else {
      // On review page
      return `Hello! I'm your AI learning assistant. I can help you understand ${topicName || "this topic"} better, answer questions, explain concepts, or generate new quiz questions. What would you like to know?`;
    }
  };
