...
import { Mail, Lock, User, Sparkles, Shield, GraduationCap, UserCircle, AlertCircle, RefreshCw, CheckCircle2, X, History, Eye, EyeOff, BookOpen } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
        ...
        <CardHeader className="space-y-3 pb-6">
          ...
          {!isSupabaseConfigured && (
            <div className="rounded-lg border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-700 dark:bg-amber-950/40 dark:text-amber-100">
              <p className="font-medium">Supabase connection required</p>
              <p className="mt-1">
                Create <code className="rounded bg-amber-100 px-1 dark:bg-amber-900/60">.env.local</code> with your Supabase URL and anon key, then restart the server.
              </p>
            </div>
          )}
        </CardHeader>
            ...
            {mode === "signup" && (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  {signupForm.watch("role") === "educator" && "Create classes and manage students"}
